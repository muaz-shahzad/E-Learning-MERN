...
const WebForm = () => {
    ...
    const handleUpload = async () => {
        ...
        try {
            const res = await axios.post("http://localhost:9002/homeadmin/Addcourse/web", data, {
                headers: {
                        ...
                        <div className="card">
                            <div className="card-header pb-0">
                                <div className="d-flex align-items-center">
                                    <h4 className="mb-0">Add Web Course</h4>
                                </div>
                            </div>
            ...
            >
                <DialogContent>
                    <DialogContentText style={{ color: "black" }} id="alert-dialog-description">
                        Web_Development Course Successfully Added 🥳
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
