...
const GraphicForm = () => {
    ...
    const handleUpload = async () => {
        ...
        try {
            const res = await axios.post("http://localhost:9002/homeadmin/Addcourse/graphic", data, {
                headers: {
                        ...
                        <div className="card">
                            <div className="card-header pb-0">
                                <div className="d-flex align-items-center">
                                    <h4 className="mb-0">Add Graphic Course</h4>
                                </div>
                            </div>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-12">
                                        <div className="form-group">
                                            ...
                                            <textarea onChange={handleFormDataChange} value={formData.course_detail} className="form-control" name='course_detail' type="text" maxLength={1090} />
                                        </div>
                                    </div>
            ...
            >
                <DialogContent>
                    <DialogContentText style={{ color: "black" }} id="alert-dialog-description">
                        Graphic Course Successfully Added 🥳
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
