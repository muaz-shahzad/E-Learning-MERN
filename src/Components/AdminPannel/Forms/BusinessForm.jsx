...
const BusinessForm = () => {
    ...
    const handleUpload = async () => {
        ...
        try {
            const res = await axios.post("http://localhost:9002/homeadmin/Addcourse/buisness", data, {
                headers: {
                        ...
                        <div className="card">
                            <div className="card-header pb-0">
                                <div className="d-flex align-items-center">
                                    <h4 className="mb-0">Add Business's Course</h4>
                                </div>
                            </div>
            ...
            >
                <DialogContent>
                    <DialogContentText style={{ color: "black" }} id="alert-dialog-description">
                        Buisness Course Successfully Added 🥳
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
